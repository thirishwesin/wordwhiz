...
@Component({
  selector: 'app-typo-word-logic',
  templateUrl: './typo-word-logic.component.html',
  styleUrls: ['./typo-word-logic.component.scss']
})
export class TypoWordLogicComponent implements OnInit {
