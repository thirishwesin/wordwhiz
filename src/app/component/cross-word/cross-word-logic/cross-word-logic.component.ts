...
@Component({
  selector: 'app-cross-word-logic',
  templateUrl: './cross-word-logic.component.html',
  styleUrls: ['./cross-word-logic.component.scss']
})
export class CrossWordLogicComponent implements OnInit {

  constructor() { }

  ngOnInit() {
    this.font_size(90,55,40);
  }
